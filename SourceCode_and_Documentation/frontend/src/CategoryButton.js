...
class CategoryButton extends Component {
    ...
    render() {
        const covidLog = this.state.isDisabled && this.state.x != 0 && this.state.y != 0 ? <CovidDialog top={this.state.y} left={this.state.x} /> : null;
        return (
            <div className={this.props.value ? 'category-button click-effect': 'category-button'} 
